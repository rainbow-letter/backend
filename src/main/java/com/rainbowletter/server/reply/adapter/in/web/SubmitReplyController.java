...
@Tag(name = "reply")
class SubmitReplyController {

    private final SubmitReplyUseCase submitReplyUseCase;

    @PostMapping("/submit/{id}")
    ResponseEntity<Void> submit(@PathVariable("id") final Long id) {
        submitReplyUseCase.submitReply(new ReplyId(id));
