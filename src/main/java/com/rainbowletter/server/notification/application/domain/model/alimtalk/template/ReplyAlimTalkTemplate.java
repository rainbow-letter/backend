...
@Component
class ReplyAlimTalkTemplate extends AbstractAlimTalkTemplate {

    ReplyAlimTalkTemplate() {
        super(AlimTalkTemplateCode.REPLY);
    }
    ...
    public List<AlimTalkButton> buttons(final Object... args) {
        ...
        final var button1 = AlimTalkButton.createWebLink("답장 보러 가기", shareLink);
